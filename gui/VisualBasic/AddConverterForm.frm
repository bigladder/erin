...
Private Sub SaveButton_Click()
    ...
    ParentSheet.Range("D" & (Lr + 1)).Value = OutflowInput.text
    ParentSheet.Range("E" & (Lr + 1)).Value = LossflowInput.text
    ParentSheet.Range("F" & (Lr + 1)).Value = ConstantEfficiencyInput.text
