...
Private Sub SaveButton_Click()
    ...
    ParentSheet.Range("D" & (Lr + 1)).Value = PrimaryOutflowInput.text
    ParentSheet.Range("E" & (Lr + 1)).Value = SecondaryOutflowInput.text
    ParentSheet.Range("F" & (Lr + 1)).Value = LossflowInput.text
    ParentSheet.Range("G" & (Lr + 1)).Value = PrimaryEfficiencyInput.text
    ParentSheet.Range("H" & (Lr + 1)).Value = SecondaryEfficiencyInput.text
