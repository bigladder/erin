VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} AddStorageForm 
   Caption         =   "Add Storage"
   ClientHeight    =   5085
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   5790
   OleObjectBlob   =   "AddStorageForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "AddStorageForm"
...
Private Sub SaveButton_Click()
    ...
    ParentSheet.Range("C" & (Lr + 1)).Value = StorageFlowInput.text
    ParentSheet.Range("D" & (Lr + 1)).Value = StorageCapacityInput.text
    ParentSheet.Range("E" & (Lr + 1)).Value = MaxStorageInflowInput.text
