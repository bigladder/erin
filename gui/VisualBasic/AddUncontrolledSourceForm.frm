VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} AddUncontrolledSourceForm 
   Caption         =   "Add Uncontrolled Source"
   ClientHeight    =   4365
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   5895
   OleObjectBlob   =   "AddUncontrolledSourceForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "AddUncontrolledSourceForm"
...
Private Sub SaveButton_Click()
    ...
    Set ParentSheet = Sheets("uncontrolled-src")
    ParentSheet.Activate
    ...
    AddComponentSubs AddUncontrolledSourceForm, idName
