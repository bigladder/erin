...
public class UnitTestForTemplateEngine
{
	[Fact]
	public void TestExampleWorks()
	{
		...
		Utils.Run(templateDir, exampleInputToml, outputToml);
		...
		List<string> diffs = Utils.ModelDifferences(exOutData, outData, path:"");
